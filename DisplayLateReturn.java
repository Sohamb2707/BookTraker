...
public class DisplayLateReturn extends JFrame {
    private DefaultTableModel tableModel;
    private JTable table;

    public DisplayLateReturn() {
        ...
        tableModel.addColumn("LateReturn_Date");
    ...
    private void retrieveDataFromDatabase() {
        try {
            ...
            String query = "SELECT * FROM latereturn"; // Replace with your table name
            ResultSet resultSet = statement.executeQuery(query);

            while (resultSet.next()) {
                String column1 = resultSet.getString("Book_Id");
                String column2 = resultSet.getString("Library_Id");
                String column3 = resultSet.getString("Return_Date");
                String column4 = resultSet.getString("LateReturn_Date");
				String column5 = resultSet.getString("Fine");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new DisplayLateReturn());
    }
}
