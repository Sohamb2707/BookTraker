...
public class DisplayBookInform extends JFrame {
    private DefaultTableModel tableModel;
    private JTable table;

    public DisplayBookInform() {
    ...
    private void retrieveDataFromDatabase() {
        try {
            ...
            String query = "SELECT * FROM bookinform"; // Replace with your table name
            ResultSet resultSet = statement.executeQuery(query);

            while (resultSet.next()) {
                String column1 = resultSet.getString("Book_Id");
                String column2 = resultSet.getString("Book_Name");
                String column3 = resultSet.getString("Author");
                String column4 = resultSet.getString("Price");
				String column5 = resultSet.getString("Publication");
	 ...
	 private void setTableColors() {
        ...
        renderer.setBackground(new Color(230,215,0));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new DisplayBookInform());
    }
}
