...
public class DisplayIssueBook extends JFrame {
    ...
    private void retrieveDataFromDatabase() {
        try {
            ...
            String query = "SELECT * FROM bookissue"; // Replace with your table name
            ...
            while (resultSet.next()) {
                ...
                String column4 = resultSet.getString("Due_Date");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new DisplayIssueBook());
    }
}
